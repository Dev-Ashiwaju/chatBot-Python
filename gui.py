...
# Menu bar
    ...
    # Options
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        help_option.add_command(label="About Rydi", command=self.msg)
